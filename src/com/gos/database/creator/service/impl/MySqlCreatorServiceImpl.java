 ...
 */
package com.gos.database.creator.service.impl;

import com.gos.database.creator.constance.NormalName;
import com.gos.database.creator.domain.DataBase;
import com.gos.database.creator.domain.PrimaryKey;
import com.gos.database.creator.domain.Table;
import com.gos.database.creator.domain.TableField;
import com.gos.database.creator.mapper.MySqlMapper;
import com.gos.database.creator.service.MySqlCreatorService;
import com.gos.database.creator.util.UnderScoreNameParser;
import com.gos.database.creator.util.VelocityEngineUtil;
...
public class MySqlCreatorServiceImpl implements MySqlCreatorService {
    ...
    private static final String TemplateBase = "/com/gos/database/creator/template";
